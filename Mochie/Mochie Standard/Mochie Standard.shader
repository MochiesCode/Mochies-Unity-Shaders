...
Shader "Mochie/Mochie Standard" {
    Properties {
		...
		_ParallaxOffset("Parallax Offset", Range(-0.5, 0.5)) = 0
		...
		[ToggleUI]_Stochastic("Stochastic Tiling", Int) = 0
		[ToggleUI]_TSS("Texture Supersampling", Int) = 0
		_TSSBias("TSS Bias", Range(-1,1)) = 0
