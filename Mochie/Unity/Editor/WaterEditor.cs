...
public class WaterEditor : ShaderGUI {
	...
	MaterialProperty _VertOffsetToggle = null;
    ...
    public override void OnGUI(MaterialEditor me, MaterialProperty[] props) {
        ...
        EditorGUI.BeginChangeCheck(); {
			...
			surfaceTabButtons.Add(()=>{}, MGUI.resetLabel);
			Action surfaceTabAction = ()=>{
				...
				MGUI.PropertyGroup( () => {
					...
					MGUI.ToggleFloat(me, "Reflectons", _Reflections, _ReflStrength);
			...
			Action norm0TabAction = ()=>{
				MGUI.Space4();
				MGUI.PropertyGroup( () => {
					me.TexturePropertySingleLine(normalLabel, _NormalMap0);
			...
			Action norm1TabAction = ()=>{
				...
				MGUI.PropertyGroup( () => {
					...
					me.TexturePropertySingleLine(normalLabel, _NormalMap1);
			...
			Action vertTabAction = ()=>{
				me.ShaderProperty(_VertOffsetToggle, "Enable");
				MGUI.Space4();
				MGUI.PropertyGroup( () => {
					MGUI.ToggleGroup(_VertOffsetToggle.floatValue == 0);
			...
			Action foamTabAction = ()=>{
				...
				MGUI.PropertyGroup( () => {
					...
					me.TexturePropertySingleLine(foamLabel, _FoamTex, _FoamColor);
	...
	void ResetSurface(){
		...
		_DistortionStrength.floatValue = 0.2f;
		_Roughness.floatValue = 0f;
		_Metallic.floatValue = 0f;
		_Opacity.floatValue = 0f;
